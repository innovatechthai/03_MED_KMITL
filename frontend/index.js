...
requester.connect(process.argv[2] ? process.argv[2] : 'tcp://192.168.1.23:5555')
...
requester.on('message', (data) => {
  ...
  var tempMax = ((0.0217*max)-177.77+calibration).toFixed(1);

  var tempMin = ((0.0217*min)-177.77+calibration).toFixed(1);
	...
	buf[i] = ((0.0217*intData[160*i + 78])-177.77+calibration).toFixed(1);
	...
	buf[i+120] = ((0.0217*intData[160*i + 79])-177.77+calibration).toFixed(1);
	...
	buf[i+120*2] = ((0.0217*intData[160*i + 80])-177.77+calibration).toFixed(1);
	...
	buf[i+120*3] = ((0.0217*intData[160*i + 81])-177.77+calibration).toFixed(1);
	...
	buf[i+120*3] = ((0.0217*intData[160*i + 82])-177.77+34+calibration).toFixed(1);
